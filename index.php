...
<html>
<head>
<title>Gnorizon Consults | Home</title>
	...
	<div class="container">
		...
		<div class="top-agileits">
			<div class="top-w3l1">
				...
				<p class="agile1">+234 706 132 5694</p>
			</div>		
			<div class="top-w3l2">
				<span class="glyphicon glyphicon-map-marker"></span>
				<p class="agileits1">Jos Nigeria</p> 
			</div>
...
<section class="banner-w3ls">
		...
		<div id="block" data-vide-bg="video/cruise" data-vide-options="position: 0% 50%">
			<div class="overlay">
				<h2>Gnorizon Consults</h2>
				
				<p style="text-align: center;">We specialize in providing technological solutions, tailor suited to our client’s needs, our solutions span, web development, mobile app development, media team setup and training, network infrastructure design and development, Internet services provision, branding, graphics design and printing services, training and research, amongst others.
				<?php 
				if(isset($_GET['message'])) 
				{	
					echo "<br><br><br>";
					echo "<tag style='color:yellow;'>";
					echo $_GET['message'];
					echo "</tag>";
				} 
				?>
...
<section class="service-agileinfo" id="service">
	<div class="container">
		...
		<div class="col-lg-3 col-md-3 col-sm-6" data-aos="flip-down">
			...
			<p class="text-center">We advise organizations and businesses on how best to use information technology (IT) in achieving their business objectives.</p>
		</div>
		<div class="col-lg-3 col-md-3 col-sm-6" data-aos="flip-down">
...
<section class="divider-wthree">
	<div class="container">
		<h3 class="text-center" data-aos="zoom-in">We turn your imaginations into reality.</h3>
...
<section class="divider-wthree">
	<div class="container">
		<h3 class="text-center" data-aos="zoom-in">We Create your public image and define your brand.</h3>
		<p class="text-center" data-aos="zoom-in">Our services are tailored to meet your desires and provide you with the best addition to take your endeavours to the next level. </p>
	</div>
</section>
<!-- /divider -->
...
<section class="divider-wthree">
	<div class="container">
		<h3 class="text-center" data-aos="zoom-in">We Connect you to the world, with top quality and dependable services.</h3>
		<p class="text-center" data-aos="zoom-in">Our services are tailored to meet your desires and provide you with the best addition to take your endeavours to the next level. </p>
	</div>
</section>
<!-- /divider -->
		...
		<div class="col-lg-8 col-md-8 contact-w3l2" data-aos="flip-left">
			<form action="processform.php" method="post">
				...
				<div class="form-group col-md-12">
					<textarea class="form-control" rows="6" name="mymessage" placeholder="Your Message" required></textarea>
				</div>
				<div class="form-group col-md-12">
					<button type="submit" name="contact" class="btn-outline2"><i class="fa fa-check-circle-o" aria-hidden="true"></i> Submit</button>
				</div>
				<div class="clearfix"></div>
			</form>	
		</div>
